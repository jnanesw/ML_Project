...
class DataIngestion:
    ...
    def download_housing_data(self):
        try:
            ...
            #If the above folder is not exists then it will create the folder, else doesn't do anything.
            os.makedirs(tgz_download_dir, exist_ok=True)

            house_file_name = os.path.basename(download_url)

            tgz_file_path = os.path.join(tgz_download_dir, house_file_name)
    ...
    def extract_tgz_file(self,tgz_file_path:str):    
        try:
            ...
            logging.info(f"Extratcion Completed!!!")
